...
public final class Catalog {
    ...
    public static void main(String[] args) throws Exception {
                ...
                new ClassReader(jar.getInputStream(entry)).accept(
                    new ClassVisitor(Opcodes.ASM9) {
                        ...
                        public void visit(
                            ...
                            name = n;
                            visible = (access & Opcodes.ACC_PUBLIC) != 0;
                        }
                        ...
                        public FieldVisitor visitField(
                            ...
                            if ((access & Opcodes.ACC_PUBLIC) != 0) members.add(
                                "{\"name\":" +
                                    Bridge.quote(n + ":" + d) +
                                    ",\"kind\":\"field\",\"static\":" +
                        ...
                        public void visitEnd() {
                            if (visible) classes.put(name, members);
                        }
                    },
        ...
        for (var entry : classes.entrySet())
            json.add(
                Bridge.quote(entry.getKey()) + ":[" + String.join(",", entry.getValue()) + "]"
            );
        Files.writeString(Path.of(args[1]), "{" + String.join(",", json) + "}");
        System.out.println(
            "Generated OpenJDK completion catalog: " + classes.size() + " public classes"
        );
    }
}
