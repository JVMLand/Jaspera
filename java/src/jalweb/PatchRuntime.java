            ...
            reader.accept(
                new ClassVisitor(Opcodes.ASM9, writer) {
                    public MethodVisitor visitMethod(
                        ...
                        if (
                            !method.equals("available0") || !desc.equals("()I")
                        ) return super.visitMethod(access, method, desc, signature, exceptions);
                        ...
                        mv.visitFieldInsn(Opcodes.GETFIELD, name, "closed", "Z");
                        Label open = new Label();
                        mv.visitJumpInsn(Opcodes.IFEQ, open);
                        mv.visitTypeInsn(Opcodes.NEW, "java/io/IOException");
                        mv.visitInsn(Opcodes.DUP);
                        mv.visitLdcInsn("Stream closed");
                        mv.visitMethodInsn(
