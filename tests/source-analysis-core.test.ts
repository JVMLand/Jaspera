...
const bundle = await build({
  stdin: {
    contents: `export {entryMethods} from './src/entry-method.ts';export {analyzeSource} from './src/source-analysis-core.ts';export {parseJal} from './src/jal-parse.ts';export {parameterSlots} from './src/parameter-slots.ts';export {calculateOffsets} from './src/offsets.ts';export {inspectSource} from './src/inspections.ts';`,
