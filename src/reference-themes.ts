...
export const referenceThemes = [
  {
    ...
    syntax: ['#663b91', '#346252', '#865e37', '#817589', '#326d7b', '#83577e'],
  },
  {
    id: 'tsukuba-night',
    label: 'Tsukuba Night',
    ...
    syntax: ['#b99ad5', '#a0bcae', '#d6b791', '#9d8da9', '#96bcc6', '#c5a0c1'],
  },
  {
    id: 'japan-light',
    label: 'Japan Light',
    ...
    syntax: ['#173b8d', '#386333', '#864500', '#646b77', '#325d86', '#792d65'],
  },
  {
    id: 'hitachi-light',
    label: 'Hitachi Light',
    ...
    syntax: ['#244f70', '#326545', '#92572e', '#65747e', '#206f76', '#79416e'],
  },
  {
    id: 'hitachi-dark',
    label: 'Hitachi Dark',
    ...
    syntax: ['#9dcbdc', '#b4cea0', '#e8b38a', '#9dadb7', '#92cdc1', '#c5b1de'],
  },
  {
    id: 'vibe-night',
    label: 'Vibe Night',
    ...
    syntax: ['#c5a0ff', '#8ceac4', '#ffd18e', '#a49aba', '#89ddff', '#f2a8ef'],
  },
  {
    id: 'vibe-light',
    label: 'Vibe Light',
    ...
    syntax: ['#7437b2', '#256b52', '#925019', '#806c94', '#25667f', '#a13885'],
  },
  {
    id: 'denden-night',
    label: 'DenDen Night',
    ...
    syntax: ['#8dc6ff', '#9bd8b1', '#efc18c', '#95aecf', '#86d8ec', '#ccadf0'],
  },
  {
    id: 'denden-light',
    label: 'DenDen Light',
    ...
    syntax: ['#0056b3', '#28663e', '#8e4d13', '#637792', '#086d83', '#7747a6'],
  },
  {
    id: 'googol-night',
    label: 'Googol Night',
    ...
    syntax: ['#8ab4f8', '#81c995', '#fdd663', '#a1a7af', '#78d9ec', '#c58af9'],
  },
  {
    id: 'googol-light',
    label: 'Googol Light',
    ...
    syntax: ['#185abc', '#188038', '#915500', '#6c737d', '#087c86', '#8430aa'],
  },
  {
    id: 'entrance-night',
    ...
    syntax: ['#79c4f5', '#a7d19a', '#e6b57d', '#a3a19f', '#74d3db', '#ceaae8'],
  },
  {
    id: 'entrance-light',
    ...
    syntax: ['#0068b8', '#39712f', '#965715', '#77736f', '#007c86', '#8250a2'],
  },
];
export function editorTheme(t: (typeof referenceThemes)[number]): editor.IStandaloneThemeData {
  ...
  return {
    ...
    rules: [
      ...
      { token: 'keyword.instruction', foreground: keyword.slice(1) },
      ...
      { token: 'type.identifier', foreground: fn.slice(1) },
      { token: 'function', foreground: fn.slice(1) },
      { token: 'delimiter', foreground: text.slice(1) },
      { token: 'operator', foreground: text.slice(1) },
    ],
    colors: {
      ...inlayHintColors(muted),
