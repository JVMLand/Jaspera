...
export interface ClassSymbol extends Span {owner:string;parents:string[];members:(Span & {kind:'method'|'field';hasCode?:boolean;static:boolean;name:string;descriptor:string})[]}
