...
const palettes:Record<string,string[]>={
 ...
 vs:['#ffffff','#f3f3f3','#c8c8c8','#333333','#616161','#005fb8','#d6ebff','#0067b8','#ffffff','#b52020','#795e00'],
 'hc-black':['#000000','#000000','#ffffff','#ffffff','#ffffff','#ffff00','#004080','#ffff00','#000000','#ff8f8f','#ffff00'],
...
export function applyTheme(id:string,save=true) {
 ...
 const root=document.documentElement;root.dataset.theme=id;root.style.colorScheme=id==='vs'||id==='hc-light'||referenceThemes.some(t=>t.id===id&&!t.dark)?'light':'dark';
