...
export interface Project {
  ...
  workspace:{layout?:WorkspaceLayout;activeFile:string;entryFile:string;stdin:string;panel:'project'|'console'|'problems'|'instructions'|'graph'|'debug';wordWrap:boolean;views:Record<string,FileView>};
}
...
export function validateProject(project:Project):Project {
  ...
  requireValue(panel==='project'||panel==='console'||panel==='problems'||panel==='instructions'||panel==='graph'||panel==='debug','表示パネルが不正です。');
