...
if(!(await readFile('public/runtime/bovine.js','utf8')).includes('jaspera_debug_enable'))throw new Error('Runtime has no debugger support. Run pnpm run build:runtime.');
